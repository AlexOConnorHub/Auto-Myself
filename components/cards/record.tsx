  ...
  return (
    <Accordion title={[record.date, record.type].join(' ')}>
      <View style={pageStyles.cardRow}>
        <ConditionalText condition={record.odometer}>Odometer: {record.odometer}</ConditionalText>
        <ConditionalText condition={record.interval}>Maintenance Interval: {record.interval} {record.interval_unit}</ConditionalText>
